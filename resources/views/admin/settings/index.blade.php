                                            ...
                                            <form action="settings/app" method="POST">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <input type="text" placeholder="Enter Estate Short Name" value="{{settings->estate->app_name}}" class="form-control" name="app_name">
                                                    </div>
                                                    <div class="col-md-6 col-sm-12">
                                                        <label for="full_name">Estate Full Name</label>
                                                        <input type="text" placeholder="Enter Estate Full Name" class="form-control" value="{{settings->estate->full_name}}" name="full_name">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class=" col-sm-12">
                                                        <label for="full_address">Estate address</label>
                                                        <textarea class="form-control" placeholder="Enter Full Estate address" name="full_address" id="" rows="3">{{settings->estate->full_address}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="">
